...
public class ApplicationConfig {
	...
	//interface is used to authenticate user credentials against a specified authentication source
	@Bean
	...
	// It is responsible for authenticating an Authentication request against the specified AuthenticationProvider(s). 
	@Bean
